    ...
    <div className="font-body overflow-x-hidden bg-cream-off text-ink">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {pastEvents.map((ev, i) => (
              <RV key={i} delay={i * 0.1}>
                <div className="bg-cream-off rounded-none overflow-hidden border border-navy/07 flex flex-col h-full">
                  {/* Image */}
                  <div className="relative overflow-hidden" style={{ aspectRatio: '16/10' }}>
                    ...
                    {/* Badge */}
                    <div className="absolute top-3 left-3 bg-ink-muted/80 text-white font-body text-xs font-semibold tracking-[.1em] uppercase px-3 py-1 rounded-none">
                      Past Event
                    </div>
                  </div>
                  {/* Body */}
      ...
      <section className="py-24 md:py-32 bg-cream-off" id="upcoming">
        <div className="max-w-[1260px] mx-auto px-6 md:px-12">
          ...
          <RV className="mb-3">
            <div className="grid grid-cols-1 md:grid-cols-2 overflow-hidden rounded-none min-h-[420px]">
              {/* Image */}
              <div className="relative min-h-[280px] md:min-h-0">
                ...
                {/* Badge */}
                <div className="absolute top-5 left-5 bg-gold text-navy font-body text-xs font-bold tracking-[.12em] uppercase px-4 py-1.5 rounded-none">
                  Featured · 2030
                </div>
              </div>
              {/* Copy */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-3">
            {upcomingEvents.slice(1).map((ev, i) => (
              <RV key={i} delay={i * 0.08}>
                <div className="relative rounded-none overflow-hidden min-h-[340px] flex flex-col justify-end group">
                  {/* BG image */}
                  <img src={ev.img} alt={ev.title}
                  ...
                  <div className="absolute top-4 right-4 flex flex-col items-end gap-1">
                    <span className="w-2 h-2 bg-gold rounded-none block" />
      ...
      <section className="bg-navy py-20 md:py-24">
        <div className="max-w-[1260px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
            ...
            {/* Quick checklist */}
            <RV delay={0.15}>
              <div className="bg-navy-mid rounded-none p-8 md:p-10 border border-white/06">
