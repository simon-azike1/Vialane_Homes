            ...
            <RV delay={0.15}>
              <div className="grid grid-cols-2 gap-3" style={{ height: 'clamp(320px,50vw,520px)' }}>
                ...
                <div className="flex flex-col gap-3">
                  <div className="bg-gold rounded-sm flex-1 flex items-center justify-center p-6">
      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-[1260px] mx-auto px-6 md:px-12">
          ...
          <RV className="mt-12 text-center">
            <WaBtn href="https://wa.me/212647574605?text=Hi%2C%20I%27d%20like%20to%20plan%20some%20Marrakech%20experiences">
              Plan My Experiences →
            </WaBtn>
          </RV>
        </div>
      ...
      <section className="py-24 md:py-32 bg-cream-off" id="visa">
        <div className="max-w-[860px] mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col gap-3">
            {/* Nigerian passport */}
            <RV>
              <div className="bg-cream border border-navy/08 rounded-sm p-8 md:p-10">
