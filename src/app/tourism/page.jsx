      ...
      <section className="bg-navy py-16 sm:py-20 md:py-28" id="services">
        <div className="max-w-[1260px] mx-auto px-6 md:px-12">
          ...
          <RV className="text-center mt-12">
            <a href="/service" className="inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-navy font-body text-xs font-bold tracking-widest uppercase px-8 py-4 rounded-none no-underline transition-all duration-200 hover:-translate-y-0.5">See All Services →</a>
          </RV>
        </div>
      </section>
